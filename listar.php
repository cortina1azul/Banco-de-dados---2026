...
<head>
    ...
    <style>
        /* CSS para a tabela não ficar bagunçada */
...
<body>
    ...
    <table>
        ...
        <td>
            <a href="deletar.php?id=<?php echo $linha['id']; ?>" class="btn-excluir" onclick="return confirm('Tem certeza que deseja excluir esse dado?')"> Excluir<a/>
        </td>
        </tr>
        <?php endforeach; ?>
